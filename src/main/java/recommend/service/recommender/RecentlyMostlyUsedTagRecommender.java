...
import com.zhiyun168.service.api.recommend.IRecentlyMostlyUsedTagRecommender;
 ...
 */
@Service
public class RecentlyMostlyUsedTagRecommender implements IRecentlyMostlyUsedTagRecommender{

    private static Logger log = LoggerFactory.getLogger(RecentlyMostlyUsedTagRecommender.class);


    @Autowired
    @Qualifier("recentlyMostlyUsedTagLoader")
    ...
    public List<String> getCandidates(Long id, int page, int pageSize) {
        ...
        recommendFeedbackLogger.view("recentlyMostlyUsed",id.toString(), candidate);
        return candidate;
    }
