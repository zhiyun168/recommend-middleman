 ...
 */
@Component("focusUserRecLoader")
public class FocusUserRecLoader extends Loader{

    private static Logger log = LoggerFactory.getLogger(FocusUserRecLoader.class);
    ...
    public List<RecItem> getCandidatesFromStorage(String id) {
        ...
        try {
            candidateStr = recGoalMapper.getFocusUserCandidate(id);
