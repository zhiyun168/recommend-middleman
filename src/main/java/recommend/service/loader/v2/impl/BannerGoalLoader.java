 ...
 */
@Component("bannerGoalLoader")
public class BannerGoalLoader extends Loader {
    private static Logger log = LoggerFactory.getLogger(BannerGoalLoader.class);
    ...
    public List<RecItem> getCandidatesFromStorage(String id) {
        ...
        try {
            candidateStr = recGoalMapper.getBannerGoalCandidate(id);
