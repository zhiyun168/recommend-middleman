 ...
 */
@Component("searchRecGoalLoader")
public class SearchRecGoalLoader extends Loader{

    private static Logger log = LoggerFactory.getLogger(SearchRecGoalLoader.class);
    ...
    public List<RecItem> getCandidatesFromStorage(String id) {
        ...
        try {
            candidateStr = recGoalMapper.getSearchRecCandidate(id);
